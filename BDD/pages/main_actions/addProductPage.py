...
class addProduct(functions):
    def addProduct(self):
        ...
        functions.click_Field(self, By.XPATH, elements["addProduct"][3])
        functions.screenShot(self, "add to cart")
        time.sleep(2)

    def validate_shopping_cart(self):
        functions.click_Field(self, By.XPATH, elements["open-cart"][0])
        functions.screenShot(self, "Visualizacion de Productos.")
        functions.click_Field(self, By.XPATH, elements["open-cart"][1])
        functions.screenShot(self, "add to cart")
        time.sleep(2)